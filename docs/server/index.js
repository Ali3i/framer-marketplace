globalThis.__VINEXT_LAZY_CHUNKS__ = ["assets/page-CnU3kW_o.js","assets/layout-segment-context-BcxXVZqQ.js"];
...
function getDraftSecret() {
	return "9f7445e9-1152-404e-9bea-244757af8b79";
}
/**
...
var NextURL = class NextURL {
	...
	*/
	get buildId() {
		return "b3c5f927-3017-42c9-b6b0-896cbb12d9ac";
	}
};
...
*/
function appIsrCacheKey(pathname, suffix, buildId = "b3c5f927-3017-42c9-b6b0-896cbb12d9ac") {
...
function createAppPageArtifactCompatibility(element, routePattern) {
	...
	return createArtifactCompatibilityEnvelope({
		...
		deploymentVersion: "b3c5f927-3017-42c9-b6b0-896cbb12d9ac",
		rootBoundaryId
	});
}
/**
...
var __publicFiles = new Set([
	...
	"/file.svg",
	"/globe.svg",
	"/images/auralis-bracelet.png",
	"/images/celeste-pendant.png",
	"/images/gift-box.png",
	"/images/hero-jewelry.png",
	"/images/sole-ring.png",
	"/window.svg"
]);
