...
var client_references_default = {
	"15c18cfaeeff": async () => {
		const m = await import("./assets/layout-segment-context-BdUoOzpY.js");
		return { get "LayoutSegmentProvider"() {
			return m["LayoutSegmentProvider"];
		} };
	},
	"593f344dc510": async () => {
		const m = await import("./assets/error-boundary-D4ZE5mD5.js");
		return {
			get "ErrorBoundary"() {
	...
	"6efdf509a785": async () => {
		const m = await import("./assets/page-DhcsVVgP.js");
		return { get "default"() {
			return m["default"];
		} };
	},
...
//#endregion
export { require_react as a, __exportAll as c, app_ssr_entry_default as default, handleSsr, useRouter as i, __toCommonJS as l, getLayoutSegmentContext as n, __commonJSMin as o, usePathname as r, __esmMin as s, require_jsx_runtime as t, __toESM as u };
